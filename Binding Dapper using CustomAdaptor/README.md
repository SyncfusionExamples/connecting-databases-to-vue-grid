# Vue Grid SQL Server Connectivity using Dapper and CustomAdaptor

A project that enables data binding and CRUD action handling in the Syncfusion Vue Grid to a SQL Server using Dapper (mapping tool) and CustomAdaptor feature of the Grid.
